...
class RandomScale(object):
    ...
    def __init__(self, scale = 0.2, diff = True , remove = 0.5):
        self.scale = scale
    ...
    def __call__(self, img, bboxes):
        ...
        img = canvas
        bboxes = clip_box(bboxes, [0,0,1 + img_shape[1], img_shape[0]], self.remove)
...
class RandomTranslate(object):
    ...
    def __call__(self, img, bboxes):        
        ...
        bboxes = clip_box(bboxes, [0,0,img_shape[1], img_shape[0]], self.remove)
...
class RandomRotate(object):
    ...
    def __call__(self, img, bboxes):
        ...
        if len(bboxes)>0:
            ...
            bboxes = clip_box(bboxes, [0,0,w, h], self.remove)
